...
/**
 * FakePizzaShareRepository
 * ==========================
 *
 * WHAT: a minimal, test-only implementation of [PizzaShareRepository] —
 * the Pizza vertical's twin of [FakeRideShareRepository]. Same role: lets
 * a test seed *exactly* the scenario it cares about.
 */
class FakePizzaShareRepository(
    initialIntents: List<PizzaShareIntent> = emptyList(),
    ...
    override suspend fun saveMatchResult(match: PizzaMatchResult): PizzaMatchResult = match
